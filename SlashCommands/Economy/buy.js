                ...
                interaction.reply({
                    embeds: [
                        new MessageEmbed().setColor("BLUE")
                            .setDescription(`Are you sure u want to purchase robkit for 12000 rs ?`)
                    ], components: [row]
                })
                        ...
                        await interaction.editReply({
                            embeds: [
                                new MessageEmbed().setColor("BLUE")
                                    ...
                                    .setDescription(" Purchase of ``12000`` successful ✅ ")
                                    .addFields(
                                        { name: '```Item``` : RobKit ', value: '``Price`` :12000', inline: true },
                                    )
